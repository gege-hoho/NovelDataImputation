...
axs.legend(["Total","Public Diary","Private Diary"])
...
axs.set_xticks(X)
axs.set_xticklabels(["All","Public Diary","Crawled Diary"])
...
def plot_gender_ages(curr_gender_ages,title,ax1):
    ...
    ax1.bar(X + 0.00, curr_gender_ages[0], width = 0.25)
    ax1.bar(X + 0.25, curr_gender_ages[1], width = 0.25)
...
plot_gender_ages(gender_ages[1],"Gender to Agegroup plot with public diary",axs[1])
plot_gender_ages(gender_ages[2],"Gender to Agegroup plot with cralwed diary",axs[2])
